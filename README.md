...
(2) Tadpole is pretrained with ***online learning***, utilizing a GPU-based solver to generate diverse data distribution without IO or storage bottlenecks induced by 3D PDE data.
...
***Read from:*** [[Arxiv](https://arxiv.org/abs/2605.15284)]
